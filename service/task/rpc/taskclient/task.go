...
type (
	CallbackRequest  = task.CallbackRequest
	CallbackResponse = task.CallbackResponse
...
func (m *defaultTask) TaskCallback(ctx context.Context, in *CallbackRequest, opts ...grpc.CallOption) (*CallbackResponse, error) {
	client := task.NewTaskClient(m.cli.Conn())
	return client.TaskCallback(ctx, in, opts...)
}
