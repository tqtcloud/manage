...
var (
	...
	hostsRowsExpectAutoSet   = strings.Join(stringx.Remove(hostsFieldNames, "`create_time`", "`update_at`", "`updated_at`", "`update_time`", "`create_at`", "`created_at`"), ",")
	hostsRowsWithPlaceHolder = strings.Join(stringx.Remove(hostsFieldNames, "`instance_id`", "`create_time`", "`update_at`", "`updated_at`", "`update_time`", "`create_at`", "`created_at`"), "=?,") + "=?"
